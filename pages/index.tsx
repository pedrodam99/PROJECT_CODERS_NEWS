...
const [highlightPost, ...posts] = originalPosts
  ...
  return (
    <div>
      ...
      <div className='w-4/5 m-auto bg-white mt-[-52px] rounded-tl-[1.875rem] min-h-[21.5rem] p-6 md:p-14 flex flex-wrap-reverse justify-around cursor-pointer' onClick={handleHighlightPostClick}>
        <div className='w-[32.75rem] max-h-80'>
        ...
        <div className='w-[24.625rem] max-h-80'>
          <img alt='Thumbnail' className="w-full h-4/5 object-cover rounded-[1.25rem] hover:opacity-90"
            src={highlightPost.fields.thumbnail.fields.file.url} />
        </div>
      </div>

      <div className='max-w-[80%] m-auto flex gap-7 flex-wrap justify-center'>
        {posts.map((post) => (
